...
class AddShowTicketChecker extends StatefulWidget {
  const AddShowTicketChecker({Key? key}) : super(key: key);

  

  @override
  State<AddShowTicketChecker> createState() => _AddShowTicketCheckerState();
}

class _AddShowTicketCheckerState extends State<AddShowTicketChecker> {
 TextEditingController nameController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBar(context, 'Add New Ticket Checker'),
      body: SizedBox(
