...
import 'package:tikect/EventOwner/ManageTicketChecker/AddManageChecker.dart';
import 'package:tikect/EventOwner/ManageTicketChecker/UpdateTicketChecker.dart';
...
class ShowTicketChecker extends StatefulWidget {
  const ShowTicketChecker({Key? key}) : super(key: key);

  @override
  State<ShowTicketChecker> createState() => _ShowTicketCheckerState();
}

class _ShowTicketCheckerState extends State<ShowTicketChecker> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: text(context, "Manage Ticket Checkers", mainTextSize, white),
        centerTitle: true,
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: iconColor,
        onPressed: () {
          goTo(context, const AddShowTicketChecker());
        },
      ),
      body: SizedBox(
            ...
            children: [
              StreamBuilder(
                stream: userCollection
                    .where('type', isEqualTo: 'ticketChecker')
                    .snapshots(),
